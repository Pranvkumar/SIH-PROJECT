  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">Live Map</CardTitle>
              ...
              <CardDescription className="text-sm">
                {locationError ? (
                  <span className="flex items-center gap-2 text-amber-600">
                    ...
                    <span className="text-xs sm:text-sm">{locationError} Showing default location.</span>
                  </span>
                ) : (
                  `Real-time view of coastal hazard reports in your area. ${approvedReports.length} approved reports shown.`
                )}
              </CardDescription>
            </div>
            <Button
